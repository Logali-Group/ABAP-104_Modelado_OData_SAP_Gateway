class ZCL_ZEPM_REF_APPS_PROD_MPC definition
  public
...
CLASS ZCL_ZEPM_REF_APPS_PROD_MPC IMPLEMENTATION.
...
lo_property->set_maxlength( iv_max_length = 81 ).
...
lo_entity_type->bind_structure( iv_structure_name = 'SEPM_CMPPRODUCT' iv_bind_conversions = 'X' ). "#EC NOTEXT
  endmethod.
...
*&---------------------------------------------------------------------*
  ...
  constants: lc_gen_date_time type timestamp value '20210811123406'. "#EC NOTEXT
