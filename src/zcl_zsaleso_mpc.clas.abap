class ZCL_ZSALESO_MPC definition
  public
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZSALESO_MPC===============CP' ##NO_TEXT.
...
CLASS ZCL_ZSALESO_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZSALESO_SRV' ).
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZSALESO_MPC=>TS_PAYMENTSTATUS' ). "#EC NOTEXT
  endmethod.
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSALESO_MPC=>TS_BRFSHCUSTOMID' ). "#EC NOTEXT
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_property = lo_complex_type->create_property( iv_property_name  = 'Buildnumber' iv_abap_fieldname = 'BUILDNUMBER' ). "#EC NOTEXT
lo_property->set_type_edm_string( ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSALESO_MPC=>TS_CONFIRMORDER' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name   = 'ZFILE'
                                iv_bind_conversions = 'X' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZSALESO_MPC=>TS_ORDERLIST' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210805121939'.                  "#EC NOTEXT
...
ls_text_element-artifact_type          = 'PROP'.                                       "#EC NOTEXT
ls_text_element-parent_artifact_name   = 'Files'.                            "#EC NOTEXT
ls_text_element-parent_artifact_type   = 'ETYP'.                                       "#EC NOTEXT
