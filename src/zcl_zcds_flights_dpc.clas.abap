class ZCL_ZCDS_FLIGHTS_DPC definition
  public
...
protected section.
  ...
  methods FLIGHTSSET_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZCDS_FLIGHTS_MPC=>TS_FLIGHTS
    raising
  ...
  methods FLIGHTSSET_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZCDS_FLIGHTS_MPC=>TT_FLIGHTS
...
CLASS ZCL_ZCDS_FLIGHTS_DPC IMPLEMENTATION.
...
*&* This class has been generated on 09.08.2021 13:13:42 in client 001
*&*
*&*       WARNING--> NEVER MODIFY THIS CLASS <--WARNING
*&*   If you want to change the DPC implementation, use the
*&*   generated methods inside the DPC provider subclass - ZCL_ZCDS_FLIGHTS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*

 DATA flightsset_create_entity TYPE zcl_zcds_flights_mpc=>ts_flights.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA flightsset_get_entity TYPE zcl_zcds_flights_mpc=>ts_flights.
 DATA lv_entityset_name TYPE string.
...
*&*   generated methods inside the DPC provider subclass - ZCL_ZCDS_FLIGHTS_DPC_EXT
*&-----------------------------------------------------------------------------------------------*
 DATA flightsset_get_entityset TYPE zcl_zcds_flights_mpc=>tt_flights.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA flightsset_update_entity TYPE zcl_zcds_flights_mpc=>ts_flights.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Unit test injection
  ...
  method IF_SADL_GW_DPC_UTIL~GET_DPC.
    ...
    DATA(lv_sadl_xml) =
               ...
               | <sadl:dataSource type="CDS" name="FlightsSet" binding="zc_flights" />| &
               |<sadl:resultSet>| &
               |<sadl:structure name="FlightsSet" dataSource="FlightsSet" maxEditMode="RO" >| &
               | <sadl:query name="EntitySetDefault">| &
               | </sadl:query>| &
               | <sadl:attribute name="CARRID" binding="CARRID" isKey="TRUE" />| &
               | <sadl:attribute name="SEATSOCC" binding="SEATSOCC" isKey="FALSE" />| &
               | <sadl:attribute name="PAYMENTSUM" binding="PAYMENTSUM" isKey="FALSE" />| &
               | <sadl:attribute name="SEATSMAXB" binding="SEATSMAXB" isKey="FALSE" />| &
               | <sadl:attribute name="SEATSOCCB" binding="SEATSOCCB" isKey="FALSE" />| &
               | <sadl:attribute name="SEATSMAXF" binding="SEATSMAXF" isKey="FALSE" />| &
               | <sadl:attribute name="SEATSOCCF" binding="SEATSOCCF" isKey="FALSE" />| &
               ...
               | <sadl:attribute name="FLDATE" binding="FLDATE" isKey="TRUE" />| &
               ...
               | <sadl:attribute name="SEATSMAX" binding="SEATSMAX" isKey="FALSE" />| &
               |</sadl:structure>| &
               |</sadl:resultSet>| &
               |</sadl:definition>| .
    ro_dpc = cl_sadl_gw_dpc_factory=>create_for_sadl( iv_sadl_xml   = lv_sadl_xml
               iv_timestamp         = 20210809131345
               iv_uuid              = 'ZCDS_FLIGHTS'
               io_query_control     = me
